...
const points = [
  ...
  "Dusch-WC AquaSense für spürbar mehr Hygiene & Komfort",
          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div>
              ...
              <h2 className="display text-[clamp(1.5rem,3.2vw,2.2rem)]">
                Wellness fürs Bad mit <em>Vitalbad AquaSense</em>
              </h2>
              <p className="mt-4 max-w-md text-base leading-relaxed text-ink-mid">
                Als zertifizierter Vitalbad-Fachpartner installieren wir das
                Dusch-WC AquaSense — für ein Gefühl von Frische und Sauberkeit,
